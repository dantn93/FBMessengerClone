...
export default class Bubble extends React.Component {
  ...
  showOriginText() {
    this.setState({
      translatedText: this.state.text,
      translateAction: "Translate",
      isTranslated: false
    });
  }
  ...
  renderMessageText() {
    if (this.props.currentMessage.text) {
      ...
      // Set message text to translated text if text was translated
      messageTextProps.currentMessage.text = this.state.translatedText;
  ...
  render() {
    let translate = null;
    // Add translate view if this is a text message
    if (
      !this.props.currentMessage.location &&
      ...
      translate = (
        <TouchableOpacity
          ...
          onPress={() => {
            // Translate text if it's not transalted yet. Otherwise, show original text
            if (!this.state.isTranslated) {
              this.onTranslate(this.props.currentMessage.text);
            } else {
              this.showOriginText();
            }
          }}
